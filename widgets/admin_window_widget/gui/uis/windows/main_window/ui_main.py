from widgets.admin_window_widget.gui.core.functions import Functions
...
from widgets.admin_window_widget.gui.uis.columns.ui_right_column import Ui_RightColumn
